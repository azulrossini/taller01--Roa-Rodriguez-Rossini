...
public class Parte01Test {
    ...
    public static void main(String[] args){
        ...
        MaterialCapacitacion video1 = new Video(32, 3.2, "godzilla");
        MaterialCapacitacion video2 = new Video(45, 4.5, "titanic");
        System.out.println(video1.titulo);
        System.out.println(video1.precio());
        System.out.println(video2.titulo);
        System.out.println(video2.precio());
        video1.liquidar();
        System.out.println("precio dsp liquidar");
        System.out.println(video1.precio());
        suscriptor2.agregar(video1);
